...
function Clock() {
    ...
    const currentDate= date.toLocaleDateString('ru', {day:'2-digit', month:'numeric', year:'numeric'})

    const stringTime = time || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут
    // студенты
    const stringDate = currentDate || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты
    ...
    return (
        <div className={s.clock}>
            ...
            <div className={s.buttonsContainer}>
                ...
                <SuperButton
                    id={'hw9-button-stop'}
                    disabled={timerId === undefined} // пишут студенты // задизэйблить если таймер не
                    // запущен
                    onClick={stop}
                >
                    stop
